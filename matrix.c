...
printf("enter the no of rows for the second matrices\n");
scanf("%d",&e);
...
if(m==e&&n==f)
{
printf("enter 1 for adition or sbtraction of matrices\n");
if(n==e)
{
...
{
printf("enter 2 fo multiplication of matrices\n");
printf("enter 3 for transpose of first matrices\n");
}
else
{
